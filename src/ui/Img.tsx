...
// Overlay colours onto the image for a smooth and consistent look

export const Overlay = () => (
	<>
		<div className="absolute inset-0 bg-[#5E6870] opacity-20 max-sm:opacity-30" />
		<div className="absolute inset-0 bg-gradient-to-t from-[rgba(0,0,0,0.5)] via-transparent to-transparent" />
		<div className="absolute inset-0 bg-[#C28680] opacity-20 max-sm:opacity-25" />
	</>
)
